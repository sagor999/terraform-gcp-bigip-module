...
variable "mgmt_subnet_ids" {
  ...
  default = [{ "network_id" = "", "subnet_id" = null, "subnet_project_id" = "", "public_ip" = null, "private_ip_primary" = null }]
}
...
variable "external_subnet_ids" {
  ...
  default = [{ "network_id" = "", "subnet_id" = null, "subnet_project_id" = "", "public_ip" = null, "private_ip_primary" = null, "private_ip_secondary" = null }]
}
